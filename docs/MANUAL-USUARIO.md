...
- **Reporte de Actividades OPP (📋 Reporte del día):** cada supervisora llena su reporte diario con
...
- **Panel de Obras Públicas (Más → 🏛️ Obras Públicas):** panel de **admin/coordinador** que
  **agrega todo el módulo** (todos los supervisores):
  ...
  - **Reporte de Actividades OPP:** consolida el reporte del día de todas las supervisoras (m³
