...
const items: { label: string; route: string; desc: string; icon: string; module: string }[] = [
  ...
  { label: 'Obras Públicas · asignar máquinas', route: 'ObrasPublicasAsignacion', desc: 'Panel de administración: asigna CUALQUIER máquina del catálogo a un supervisor externo, filtrando por varias empresas y por estado (operativa, averiada, en espera, inactiva)', icon: '🧭', module: 'op_asignacion' },
