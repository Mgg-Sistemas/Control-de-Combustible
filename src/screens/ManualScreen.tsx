...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📄 Reporte de CONTEO de equipos (desde el Catálogo): es solo conteo + detalle, SIN horas ni precios. Agrupa por TIPO de equipo (el nombre del equipo, p. ej. "CAMIÓN VOLTEO TORONTO") mostrando "TIPO — TOTAL n" y, bajo cada tipo, los equipos por empresa (con ID, placa, serial, encargado y estado). Eliges el ALCANCE (General o una empresa). El filtro por tipo es una LISTA DESPLEGABLE con buscador y CASILLAS: ábrela, escribe (ej. "volteo toronto") y tilda uno o varios tipos para ver solo esos. Botón ⬇️ Descargar PDF (conteo).' },
