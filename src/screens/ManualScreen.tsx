...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📋 Reportes (hub): dentro de Inspecciones/Supervisión hay un hub de reportes en tarjetas, organizado en secciones desplegables con buscador de reportes: (1) Máquinas asignadas por inspector → Reporte por inspector, Entrada y salida de camiones; (2) Distribución de guardias; (3) Camiones (asistencia) → asistencia diaria, por empresa, sin asistencia; (4) Jornadas de operadores → horas por operador, jornadas por sector; (5) Traza por inspector → recorrido del inspector. Cada tarjeta abre un cuadro para elegir día o rango (y a veces filtrar inspector/operador) y genera el PDF.' },
      { t: 'note', text: '🗓️ Distribución de guardias (dentro de Inspecciones): arma la rotación de inspectores por rango de fechas. Agregas inspectores (trae su cédula del perfil; editas teléfono, sector, cargo=Coordinador/Nocturno/Inspector y grupo A/B/C), defines sus DESCANSOS por rango a mano, o tocas ⚙️ Autogenerar 14x7 para crear 3 grupos con una semana de descanso cada uno (nunca descansan a la vez dos coordinadores ni dos nocturnos). Ves el calendario inspector×día (T en turno / D en descanso, coloreado por grupo) con la fila "En descanso", te avisa si dos coordinadores coinciden en descanso, y con 📄 Generar PDF sale el documento del ciclo (calendario + conformación de grupos + cobertura).' },
