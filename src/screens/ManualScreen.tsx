...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'Detalle por edificio (reporte diario): en cada edificio hay un "▾ Detalle" que despliega los campos del reporte diario — m³ acarreados, viajes, % de avance, maquinaria en uso / inoperativa / por requerimiento, cuerpos (supervivientes / fallecidos), actividades del día y un interruptor "✅ Frente entregado". Es opcional y se guarda con el mismo botón Guardar (un edificio se guarda aunque no tenga m³ si le pusiste detalle).' },
