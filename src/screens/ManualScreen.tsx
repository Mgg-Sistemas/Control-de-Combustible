...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '👤 POR PERSONA (vista principal): es un listado de empleados. Busca a alguien y ábrelo: verás sus datos personales, sus datos bancarios y sus tarifas. Con "➕ Generar pago" registras un pago indicando la frecuencia — Diario (☀️ día / 🌙 noche), Semanal, Quincenal o Mensual —, la cantidad y el monto (se sugiere solo desde su tarifa y lo puedes cambiar), el método, concepto y nota. De cada pago sacas su 📄 Recibo. Abajo tienes el HISTORIAL de esa persona con el total, lo puedes 🖨️ Imprimir (histórico por persona) y cada movimiento se puede ✏️ Editar o 🗑️ Borrar.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📍 Referencia de ubicación: dentro del check-in, además de guardar la ubicación GPS, el inspector puede escribir una REFERENCIA (edificio, residencia, plaza, calle…) y toca "📍 Guardar/Actualizar ubicación + referencia". Esa referencia se ve luego en el reporte "📄 Referencias por sector (Este / Oeste)" del Mapa, que agrupa las máquinas por su sector geográfico y muestra su referencia, inspector y empresa.' },
  ...
  },
  {
    ...
    blocks: [
      { t: 'bullets', items: [
        ...
        'Mapa · Reporte "📄 Referencias por sector (Este / Oeste)": agrupa las máquinas UBICADAS por su SECTOR geográfico (macro 🟢 Este / 🟠 Oeste y su sub-sector, según el GPS de la máquina). Por cada máquina lista su placa/serial, la REFERENCIA de ubicación (edificio, residencia, plaza, calle), el inspector asignado y la empresa. Las que no tienen GPS salen en "Sin zona".',
