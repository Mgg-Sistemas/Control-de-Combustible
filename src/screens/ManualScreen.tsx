...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Conteo de equipos: en Reportes, la pestaña 📊 Conteo equipos muestra cuántos equipos hay por clasificación (ej. REMOCIÓN Y EXCAVACIÓN 70) y por tipo (JUMBO, RETROEXCAVADORA…). Arriba tiene tres botones: "Todos", "Con horas" y "Sin horas"; al tocarlos, el conteo muestra solo esos equipos (los que trabajaron o los que no). Al final, los totales de la flota: activos, inactivos y stand by, más el total con/sin horas. El PDF sale con el filtro elegido. No depende de fechas (cuenta todo el catálogo). Se puede descargar en PDF.' },
    ],
  },
  {
    icon: '💰',
