...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Conteo de equipos: en Reportes, la pestaña 📊 Conteo equipos. El desglose por ZONA usa SOLO los equipos UBICADOS en el mapa (con GPS); los que no tienen ubicación no se cuentan ahí. El filtro por zona muestra cada zona geográfica con su cantidad (ej. Este · Caraballeda, Oeste · Aeropuerto…); al tocar una, las tablas por clasificación y por tipo se recalculan solo con esa zona. Aparece "A disposición de" (cuántas están a disposición de Gobernación/FANB/CVM… e indica en qué zona), y "Por tipo y zona" (ej. JUMBO (21): 9 en Este · Caraballeda, 4 en Oeste · Aeropuerto…). El botón "🗺️ Ver en mapa" abre el mapa de calles con las zonas y los puntos, y debajo las leyendas (zonas, a disposición de, por tipo y zona). Las tarjetas de arriba muestran el estado de la flota (activos/inactivos/stand by). Se actualiza solo al cambiar una máquina y se puede descargar en PDF. La "A disposición de" se asigna a cada máquina en el catálogo de Equipos.' },
    ],
  },
  {
    icon: '💰',
