...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📍 Ubicaciones tácticas (botón en 📊 Conteo de equipos): genera el "Reporte Diario de Operaciones y Maquinaria – Operación Rescate y Esperanza, La Guaira" en PDF. Trae las máquinas REALES agrupadas por QUIÉN LAS TIENE A CARGO (CVM / Gobernación / FANB / SOS La Guaira, según el campo "a disposición de" del equipo), cada una con su empresa, ubicación real (referencia + sector Este/Oeste y subzona por GPS: Macuto, Caraballeda, Aeropuerto…) y estado (Operativo / Inoperativo / En espera). Incluye una sección con las camionetas PICK-UP del módulo de Vehículos a disposición de SOS La Guaira, y deja campos en blanco para llenar a mano (fecha, inspector, turno, hora de fin, sector y observaciones).' },
    ],
  },
  {
    icon: '💰',
