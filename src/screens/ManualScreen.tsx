...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Vehículos con ficha completa + FOTO: al cargar un VEHÍCULO (🚗) el formulario se ve igual que el de maquinaria — NOMBRE del vehículo (arriba, como el "Código/Nombre" de la maquinaria; opcional, la placa sigue siendo el identificador), marca, modelo, clasificación, tipo, identificador, serial, empresa supervisora, grupo y ENCARGADO (el encargado va justo debajo de "Esperando instrucciones", ya no escondido al final). En la tarjeta, si el vehículo tiene nombre se muestra como título y la placa debajo. La FOTO se ve como en las máquinas: toca la MINIATURA de la tarjeta y se abre el visor ampliado con la foto del vehículo y la del serial/placa, cada una con "🔄 Cambiar foto" y "🗑 Quitar foto". Los vehículos SIGUEN siendo aparte de la maquinaria: NO entran a Control, Inspecciones ni pagos por jornada; son solo para combustible y autorizaciones. (Requiere haber corrido supabase/vehiculos_ficha_maquinaria.sql, supabase/vehiculos_encargado.sql y supabase/vehiculos_nombre.sql; si no, esos campos no se muestran y el formulario de vehículo sigue en su versión básica.)' },
    ],
  },
  {
    icon: '🏛️',
