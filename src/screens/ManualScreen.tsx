...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'p', text: 'Panel de Obras Públicas (Más → 🏛️ Obras Públicas): panel de admin/coordinador que AGREGA todo el módulo (todos los supervisores). Muestra KPIs (máquinas asignadas, trabajando ahora, averiadas/paradas, m³ del día, edificios), gráficos (acarreo total por día, distribución por estado 7/30), el estado de la flota en campo con sus m³ removidos (y su supervisor) y la tabla de registros de acarreo. Puedes filtrar por supervisor con los chips de arriba, y tocar un KPI para filtrar la flota.' },
