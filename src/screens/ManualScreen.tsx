...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '🟢 EL ESTADO DEL CAMIÓN YA NO IMPIDE REGISTRAR (31/08/2026). En ESTE módulo y solo en este, no importa cómo figure el camión: averiado, parado, retirado o en espera de instrucciones, TODOS salen en el buscador y TODOS aceptan viajes. Y ya no pregunta nada antes de guardar: donde antes salía "este camión figura AVERIADA, ¿de todas formas quieres registrar el viaje?", ahora registra y ya. El motivo: un viaje es algo que el listero VIO —el camión entró— mientras que el estado es una anotación de otro módulo que puede estar vieja o mal puesta; cuando las dos cosas se contradicen, gana lo que se vio. Antes, un camión marcado por error se quedaba sin manera de anotarle los viajes, y esos viajes se perdían. ESTO REEMPLAZA la regla del 18/08/2026, que sacaba de la lista del listero las retiradas y las que estaban en espera.' },
