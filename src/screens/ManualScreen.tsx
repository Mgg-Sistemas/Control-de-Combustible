...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Conteo de equipos: en Reportes, la pestaña 📊 Conteo equipos. Cuenta TODAS las máquinas activas (el total es como siempre) por clasificación y por tipo. Aparte, INDICA las zonas: el filtro por zona muestra cada zona geográfica con su cantidad (solo los equipos UBICADOS en el mapa; ej. Este · Caraballeda, Oeste · Aeropuerto…) y cuántos están ubicados en total (ej. 90); al tocar una zona, las tablas se recalculan con esa zona. "A disposición de" indica cuántas están a disposición de Gobernación/FANB/CVM… (cuenta todas, con o sin ubicación) y en qué sector (Este/Oeste) las ubicadas. "Por tipo y zona" muestra, para cada tipo, cuántas hay en cada zona (solo ubicados). El botón "🗺️ Ver en mapa" abre el mapa de calles con las zonas y los puntos, y debajo las leyendas. Las tarjetas de arriba muestran el estado de la flota. Se actualiza solo al cambiar una máquina y se descarga en PDF. La "A disposición de" se asigna en el catálogo de Equipos.' },
    ],
  },
  {
    icon: '💰',
