...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '🔵 Círculo de estado en cada máquina asignada: 🟢 VERDE = jornada en curso (trabajando) · 🟡 AMARILLO = parada (avería) · 🔴 ROJO = jornada finalizada. Además cada máquina muestra su 📍 edificio/referencia y su serial/placa.' },
