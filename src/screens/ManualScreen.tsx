...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '👷 Ubicaciones tácticas CON PERSONAL: al lado del botón hay un SWITCH "Solo ubicaciones / Con personal". Actívalo antes de descargar y el reporte reparte la nómina en los equipos de SOS La Guaira (NO en los de CVM / Gobernación / FANB): a cada máquina le asigna 2 OPERADORES (uno de turno DÍA y uno de turno NOCHE), en rotación por la lista de operadores; y agrega una sección con los COORDINADORES e INSPECTORES repartidos por zona (ESTE / OESTE). Los cargos se toman del campo "cargo" del empleado (operador, coordinador, inspector).' },
      { t: 'note', text: '👥 Personal por departamento (botón en 📊 Conteo de equipos): genera el "Reporte de Personal" con TODA la nómina activa (del administrativo a los ayudantes de cocina). Arriba lleva un mensaje de agradecimiento y el TOTAL de personal; luego la cantidad por DEPARTAMENTO y por CARGO; y al final el listado por departamento con nombre, cargo y cédula.' },
    ],
  },
  {
    icon: '💰',
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Adjuntar un FORMATO (imagen o PDF): en cada requerimiento toca "📎 Subir formato" y elige una imagen o un PDF (cotización, formato firmado, etc.). Queda guardado en el requerimiento (📎 Formato adjunto). Con "👁️ Ver formato" se abre la vista previa (la imagen o el PDF) con botón "⬇️ Descargar / Abrir". Al APROBAR un requerimiento que trae formato, la vista previa se abre sola para revisarlo y descargarlo.' },
  ...
  },
  {
    ...
    blocks: [
      { t: 'bullets', items: [
        ...
        'Mapa · Reporte "📄 Máquinas por sector (Este / Oeste)": agrupa las máquinas UBICADAS por su SECTOR geográfico (macro 🟢 Este / 🟠 Oeste y su sub-sector, según el GPS de la máquina), con su placa/serial, inspector asignado y empresa. Las que NO están en el mapa salen aparte como "⛔ SIN UBICACIÓN (faltan por ubicar)" con su placa/serial.',
