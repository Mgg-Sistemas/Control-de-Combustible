...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Conteo de equipos: en Reportes, la pestaña 📊 Conteo equipos muestra cuántos equipos hay por clasificación (ej. REMOCIÓN Y EXCAVACIÓN 70) y por tipo (JUMBO, RETROEXCAVADORA…). En vez de las horas, cada fila indica cuántos equipos están CON horas y cuántos SIN horas (si trabajaron o no). Al final, los totales de la flota: activos, inactivos y stand by, más el total con/sin horas. No depende de fechas (cuenta todo el catálogo). Se puede descargar en PDF.' },
    ],
  },
  {
    icon: '💰',
