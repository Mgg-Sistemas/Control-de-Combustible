...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Solo cantidad de equipos: en el reporte 🚚 Maquinaria/Vehículo, el botón "🔢 Solo cantidad de equipos (sin horas ni precio)" genera un PDF con el DETALLE equipo por equipo en orden alfabético (A→Z), más los totales por clasificación y por empresa. Es GENERAL (todas las empresas); si arriba filtras por una empresa, sale solo de esa. Sin horas ni montos.' },
