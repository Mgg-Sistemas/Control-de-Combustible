  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'steps', items: [
        ...
        'Toca un CARGO para abrirlo y ver su gente. En cada PERSONA aparecen las SEMANAS del ciclo con sus FECHAS reales; toca la semana en que esa persona descansa (se marca de color al instante).',
        'Si otra persona DEL MISMO CARGO ya descansa esa semana, el botón muestra "⚠ N más" para avisarte del CHOQUE y repartas mejor.',
        'Toca "✨ Repartir automático" (arriba) para que dentro de cada cargo la gente quede en semanas distintas de una vez (sin juntar la misma semana). Luego ajustas a mano tocando otra semana.',
        'Arriba está "Personas libres por semana": cuántas descansan cada semana, para ver de un vistazo si se juntan.',
        'También puedes poner a una persona una semana libre en OTRA fecha con "➕ Semana libre en otra fecha", o "Limpiar ✕" para borrar la de esa persona.',
