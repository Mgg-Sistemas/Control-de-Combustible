...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📍 Edificio / residencia: en cada máquina del catálogo se muestra el edificio o residencia donde está (con el sector, ej. "📍 EDIFICIO PUNTA PIEDRA - MACUTO"). Sale del catálogo de ubicaciones; el sector geográfico (🧭 Este/Oeste) se sigue calculando aparte desde el GPS.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '🛰️ Edificio auto-detectado del GPS (20-ago-2026): al abrir el check-in, tomar de nuevo la ubicación o Actualizar ubicación + referencia, el Edificio se autocompleta con el SECTOR donde cae el GPS (ej. "Este · Camurí Chico"), así el edificio siempre cuadra con la ubicación real. Puedes cambiarlo a mano antes de guardar; si el GPS cae fuera de zona, se respeta lo escrito. Además "↻ Volver a tomar ubicación" ahora fuerza una lectura NUEVA del GPS (antes repetía la de hasta 2 min y parecía no hacer nada).' },
