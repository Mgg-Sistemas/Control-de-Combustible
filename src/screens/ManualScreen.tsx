...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '✅ CHECK MÁQUINA (asignación): cada inspector solo ve en su ronda las máquinas que tiene ASIGNADAS. Para asignarse una, toca el botón ✅ CHECK MÁQUINA (debajo del escáner), busca la máquina por nombre/serial/placa y tócala para asignártela (o quitártela). La asignación casa la persona logueada con la máquina y queda en la Auditoría (✅ se asignó). El administrador tiene además "Ver todas" para ver el listado completo.' },
      ...
      { t: 'note', text: 'Dos reportes en Inspecciones: (1) 📊 Reporte por inspector (día/rango, con hora, sector, serial/placa, empresa y ESTADO de la máquina); y (2) 📄 Asignaciones por sector (las máquinas que cada inspector se asignó con el CHECK, agrupadas POR SECTOR, con referencia + serial + placa + empresa, SIN el estado de la máquina).' },
