...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '👤 DOS COSAS QUE HAY QUE SABER ANTES DE RECLAMAR UN FALTANTE. (1) DOS CUENTAS = DOS LISTEROS: el reporte agrupa por la CUENTA de usuario, no por el nombre escrito. Si una misma persona tiene un usuario viejo y uno nuevo, sale en DOS renglones aunque se llame igual — y está bien: el sistema no puede adivinar que dos cuentas son la misma persona. (2) EL CORTE ES POR DÍA DE CALENDARIO, NO POR JORNADA: el reporte va de medianoche a medianoche y ahora lo dice en el encabezado del PDF. Una jornada de NOCHE va de 7pm a 7am, así que sus viajes salen repartidos EN DOS DÍAS: los de antes de las 12 en un día y los de la madrugada en el siguiente. Un listero de noche que registró 7 viajes puede ver "4" si se mira un solo día. No falta nada: hay que sumar los dos días. El nombre que sale es el que tenía cuando registró el viaje, no el de hoy; si se lo corrigieron después, el reporte los junta igual (agrupa por cuenta) y rotula el grupo con la forma más usada.' },
    ],
  },
  {
    icon: '⚙️',
