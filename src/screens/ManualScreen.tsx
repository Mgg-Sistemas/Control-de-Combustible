...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Solo cantidad de equipos: en el reporte 🚚 Maquinaria/Vehículo, el botón "🔢 Solo cantidad de equipos (sin horas ni precio)" genera un PDF con el DETALLE de las máquinas AGRUPADO POR EMPRESA, y dentro de cada empresa una por una en orden alfabético (A→Z); más los totales por clasificación y por empresa. Es GENERAL (todas las empresas); si arriba filtras por una empresa, sale solo de esa. Sin horas ni montos.' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'El precio se congela AL CERRAR el corte, no antes. La semana ABIERTA usa el precio actual: si cambias el precio de la semana en curso, los reportes lo reflejan de inmediato. Al CERRAR esa semana, su precio queda fijo para siempre (cambiarlo después NO la afecta). Consejo: pon el precio de la semana → revisa el reporte → cierra el corte. Solo los cortes YA cerrados quedan blindados.' },
