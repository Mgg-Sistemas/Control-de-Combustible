...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Solo cantidad de equipos: en el reporte 🚚 Maquinaria/Vehículo, el botón "🔢 Solo cantidad de equipos (sin horas ni precio)" genera un PDF con únicamente la CANTIDAD de equipos por clasificación y por empresa (respeta los filtros de empresa/tipo que tengas puestos). Sin horas ni montos.' },
