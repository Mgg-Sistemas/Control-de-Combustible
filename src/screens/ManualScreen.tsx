...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📄 Sacar UNA SOLA hoja (25-ago-2026, pedido del taller): antes «Exportar PDF» sacaba TODO lo del filtro, y como «Desde» y «Hasta» arrancan vacíos, quien registraba un servicio de prueba recibía un PDF con ese, con el que ya tenía montado y con los expedientes viejos del taller, todo junto. Ahora cada servicio de la lista tiene su botón «📄 Solo esta hoja»: saca ESE y nada más, en una sola página, sin ficha técnica (la hoja ya lleva la foto, el equipo y el serial) y sin arrastrar ningún otro registro.' },
      ...
      { t: 'note', text: '👁️ El botón dice cuánto va a sacar ANTES de tocarlo, y solo promete un número cuando puede cumplirlo: con la casilla de los expedientes viejos APAGADA dice «📄 Exportar 3 hojas» (exacto); ENCENDIDA dice «📄 Exportar 3 servicios + viejos», porque cada expediente viejo también sale como una hoja entera y cuántos hay no se sabe sin consultarlos. Prometer un total falso sería repetir la misma sorpresa.' },
