...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📊 Total del rango por máquina: justo debajo del botón de flete, cada máquina muestra su TOTAL DE HORAS y su TOTAL EN $ del rango de fechas seleccionado (horas × precio/hora). El mismo total (horas · $) también sale en el resumen compacto cuando la tarjeta está cerrada. Si la máquina no tiene precio, dice "sin precio".' },
