  ...
  },
  {
    ...
    blocks: [
      { t: 'bullets', items: [
        ...
        'Mapa · Reporte "📄 Referencias": genera un PDF con las máquinas que tienen una REFERENCIA de ubicación (edificio, parque, plaza, calle) puesta por el inspector al marcar la ubicación. Sale el nombre de la máquina, su placa/serial, la referencia y la empresa.',
