...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Vehículos con ficha completa + FOTO: al cargar un VEHÍCULO (🚗) el formulario se ve igual que el de maquinaria — marca, modelo, clasificación, tipo, identificador, serial, empresa supervisora, grupo y encargado — y se le puede subir una FOTO desde su tarjeta ("📷 Agregar/Cambiar foto"). Los vehículos SIGUEN siendo aparte de la maquinaria: NO entran a Control, Inspecciones ni pagos por jornada; son solo para combustible y autorizaciones. (Requiere haber corrido supabase/vehiculos_ficha_maquinaria.sql; si no, el formulario de vehículo sigue en su versión básica.)' },
    ],
  },
  {
    icon: '🏛️',
