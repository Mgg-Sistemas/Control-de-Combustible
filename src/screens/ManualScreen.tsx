  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'steps', items: [
        ...
        'Puedes FILTRAR: por DEPARTAMENTO (toca el departamento en 🔎 Filtrar) o por CARGO (escribe en "Buscar cargo…"). Así trabajas un departamento a la vez y no todos los cargos juntos. La semana libre y el PDF se generan solo sobre lo filtrado (útil para armar la rotación de un departamento por separado). "Limpiar ✕" quita el filtro.',
        'Elige el "Ciclo" (Desde / Hasta) arriba.',
        'DIRECTO POR CARGO: en cada cargo aparecen las SEMANAS del ciclo con sus FECHAS reales; toca la semana en que ese cargo descansa (se marca de color al instante). Si otra fila ya descansa esa semana, el botón muestra "⚠ N cargo(s)" para avisarte del CHOQUE y elijas otra.',
        'Toca "✨ Repartir automático" (arriba) para que el sistema reparta cada cargo en una semana DISTINTA de una vez, SIN CHOQUES. Luego puedes ajustar cualquiera a mano tocando otra semana.',
        'El calendario cargo×día muestra L = semana libre / T = trabaja, con color por semana; abajo "Cargos libres" cuenta cuántos descansan cada día (para ver de un vistazo si se juntan).',
        'También puedes poner una semana libre en OTRA fecha con "➕ Semana libre en otra fecha" (eliges Desde / Hasta), o "Limpiar ✕" para borrar la de un cargo.',
        'Toca "📄 Generar PDF" para el calendario imprimible de días libres por cargo (respeta el filtro).',
      ] },
