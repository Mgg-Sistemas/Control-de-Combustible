...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '📄 Reportes de maquinaria (desde el Catálogo): genera el listado de equipos agrupado por empresa → tipo, con totales y el detalle de cada máquina. Eliges el ALCANCE (General o una empresa) y "Agrupar y filtrar por": 🗃️ Clasificación (las 4 grandes) o 🚜 Modelo (tipo específico, p. ej. "CAMIÓN VOLTEO TORONTO"). El filtro es BUSCABLE y con CASILLAS: escribe y marca uno o varios tipos para ver solo esos (útil en Modelo, que trae muchos). Con el botón "Sin precios" el reporte queda sin montos (equipos, totales por tipo y detalle, sin horas ni dinero). Botón ⬇️ Descargar PDF.' },
