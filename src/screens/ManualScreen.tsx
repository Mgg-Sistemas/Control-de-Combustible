...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '✅ Máquinas asignadas por inspector (CHECK): arriba del módulo de Inspecciones sale la lista de qué máquinas se asignó cada inspector con el botón ✅ CHECK MÁQUINA del teléfono (inspector → sus máquinas, con serial/placa, empresa y fecha/hora de asignación). Se sincroniza EN VIVO: apenas un inspector se asigna una máquina, aparece aquí. Tiene su propio 📄 PDF de asignaciones.' },
