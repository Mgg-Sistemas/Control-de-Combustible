  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'steps', items: [
        ...
        'La vista es un CALENDARIO tipo matriz: filas = personas (agrupadas por su cargo), columnas = las semanas del ciclo con sus fechas. Toca la celda de una persona en una semana para marcar ahí su DÍA LIBRE (se pinta de color); toca la celda ya marcada para quitarla.',
