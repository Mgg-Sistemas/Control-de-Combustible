...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: '🔎 Buscar por tipo de equipo (solo cantidad): dentro de la vista previa del reporte 🚚 Maquinaria/Vehículo hay un buscador. Escribe el tipo (por ejemplo "volqueta toronto") y te muestra un NÚMERO grande con el TOTAL de unidades que coinciden en TODAS las empresas, y debajo el desglose por empresa. Busca por nombre/código, marca-modelo y clasificación a la vez (cada palabra debe aparecer), así "volqueta toronto" halla los camiones volqueta Toronto de toda la flota. Botón "⬇️ PDF de este conteo" para imprimirlo.' },
