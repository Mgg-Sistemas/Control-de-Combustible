...
const SECTIONS: Sec[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { t: 'note', text: 'Conteo de equipos: en Reportes, la pestaña 📊 Conteo equipos muestra cuántos equipos ACTIVOS hay por clasificación (ej. REMOCIÓN Y EXCAVACIÓN 70) y por tipo (JUMBO, RETROEXCAVADORA…). Tiene un filtro por ZONA (ubicación en el mapa, según GPS): cada chip muestra cuántas máquinas hay ubicadas en esa zona geográfica (ej. Este · Caraballeda, Oeste · Aeropuerto…) y "Sin zona" son las que aún no tienen ubicación GPS. Al tocar una zona, las tablas se recalculan solo con esas máquinas. En la vista de TODAS aparece además "Por tipo y zona": para cada tipo, cuántas hay en cada zona (ej. JUMBO (21): 9 en Este · Caraballeda, 4 en Oeste · Aeropuerto…). Al final, los totales de la flota: activos, inactivos y stand by. El reporte se actualiza solo cada vez que se cambia o agrega una máquina, y no depende de fechas. Se puede descargar en PDF (incluye el resumen por zona y el desglose por tipo y zona).' },
    ],
  },
  {
    icon: '💰',
