  ...
  const step2 = stepSection(2, 'Mangueras hidráulicas', 'Confección/reparación por máquina, con su ciclo de instalación y de pago',
    twoCol(
      ...
      stepList([
        ...
        'El botón **📤 Enviar a autorización** manda el pago de ⏳ Pendiente a **📤 Pendiente por autorización**. Eso genera una **alerta (campana)** para los administradores — igual que un requerimiento de compra.',
        '📄 **Autorización (PDF):** desde la manguera (cuando está en autorización o ya pagada) se descarga un PDF con sus datos y la **firma del Director General (Jesús Lozada)** — para enviárselo a autorizar o guardarlo como constancia. Si aún no está pagada, sale la línea para firmar; una vez pagada, sale la firma escaneada.',
